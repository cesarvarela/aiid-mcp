...
server.tool("get-classifications", "Fetch classifications from the AIID GraphQL API. Supports filtering, pagination, sorting, and selecting specific classification fields.", getClassificationsShape, getClassifications);
server.tool("get-taxonomies", "Fetch taxonomies from the AIID GraphQL API. Supports filtering, pagination, sorting, and selecting specific taxonomy fields.", getTaxonomiesShape, // Corrected: Use the shape directly
getTaxonomies);
